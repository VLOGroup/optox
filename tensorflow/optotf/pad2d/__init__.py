...
__all__ = ['pad2d', 'pad2d_transpose']

# load operators from the library
_ext = tf.load_op_library(tf.compat.v1.resource_loader.get_path_to_datafile("tf_pad2d_operator.so"))
...
# to run execute: python -m unittest [-v] optotf.pad2d
