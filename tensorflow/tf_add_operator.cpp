...
class TFCustomAddOp : public OpKernel {
public:
	
	explicit TFCustomAddOp(OpKernelConstruction* context) 
		: OpKernel(context)
	{
	...
	void Compute(OpKernelContext* context) override {
        ...
        applyAddOperator<dtype>()(context->eigen_device<GPUDevice>(), output, a_flat, b_flat);
	}
};
