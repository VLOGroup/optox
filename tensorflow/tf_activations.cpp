...
// quadratic b-spline activation

REGISTER_OP("ActivationQuadBSpline")
    .Attr("T: realnumbertype")
    .Input("x: T")
    .Input("w: T")
    .Output("output: T")
    ...
    .SetShapeFn(shape_inference::UnchangedShape)
/*    .Doc(strings::StrCat(R"doc(
Computes an activation function parameterized by weighted quadratic B-spline basis
functions.)doc",
ActivationCommonIOs,
ActivationCommonAttrs))*/;

REGISTER_OP("ActivationQuadBSplineGradW")
    .Attr("T: realnumbertype")
    .Input("x: T")
    .Input("grad_out: T")
    .Output("output: T")
...
/*    .Doc(strings::StrCat(R"doc(
Backpropagates the gradient from the quadratic B-spline basis activation function
output to the corresponding weights.
)doc",
ActivationGradWCommonIOs,
ActivationCommonAttrs))*/;

REGISTER_OP("ActivationPrimeQuadBSpline")
    .Attr("T: realnumbertype")
    .Input("x: T")
    .Input("w: T")
    .Output("output: T")
    ...
    .SetShapeFn(shape_inference::UnchangedShape)
/*    .Doc(strings::StrCat(R"doc(
Applies the first derivative of a quadratic B-spline activation function to the
input 'x'. Note that the derivative is computed by a weighted sum of the first
derivative of the basis functions.)doc",
ActivationCommonIOs,
ActivationCommonAttrs))*/;
...
REGISTER_OP("ActivationIntegralInterpolateLinear")
    .Attr("T: realnumbertype")
    .Input("x: T")
    .Input("w: T")
    .Output("output: T")
...
REGISTER_OP("ActivationIntegralInterpolateLinearGradW")
    .Attr("T: realnumbertype")
    .Input("x: T")
    .Input("grad_out: T")
    .Output("output: T")
...
// quadratic b-spline quadratic Activation Functor
template<typename T>
inline T b_spline_quad(T x)
{
  x = fabs(x);
...
template<typename T>
inline T b_spline_quad_prime(T x)
{
            ...
            switch(N)
            {
              case tficg::DO_ZERO:
                switch(S)
                {
                  ...
                  case tficg::SO_QUADRATIC:
                    b_spline = b_spline_quad<T>(dx - alpha);
                  break;
                  case tficg::SO_CUBIC:
              ...
              case tficg::DO_FIRST:
                switch(S)
                {
                  ...
                  break;
                  case tficg::SO_QUADRATIC:
                    b_spline = b_spline_quad_prime<T>(dx - alpha) / (-d);
                  break;
                  case tficg::SO_CUBIC:
