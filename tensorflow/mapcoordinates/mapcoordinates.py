...
if os.path.isfile(lib_path):
    if "lib_so" in locals():
        ...
        ###########################
        # CUSTOM LOAD code
        my_mapcoordinates = lib_so.mapcoordinates
        mgrad = lib_so.mapcoordinates_gradients
        
        from tensorflow.python.framework import ops 
        
        @ops.RegisterGradient("Mapcoordinates")
...
elif hasattr (tf.contrib,"icg") and hasattr (tf.contrib.icg,"mapcoordinates"):
  ...
  my_mapcoordinates = tficg.mapcoordinates
  mgrad = tficg.python.ops.icg_ops.mapcoordinates_gradients
else:
   assert False, "Needs icg version of tensorflow built from source!"
