///@file th_pad3d_operator.h
///@brief PyTorch wrappers for pad3d operator
...
template<typename T>
at::Tensor forward(optox::Pad3dOperator<T> &op, at::Tensor th_x)
{
    // parse the tensors
...
template<typename T>
at::Tensor adjoint(optox::Pad3dOperator<T> &op, at::Tensor th_grad_out)
{
    // parse the tensors
...
{
    std::string pyclass_name = std::string("Pad3d_") + typestr;
